...
class HomeGallery(models.Model):
    ...
    gallery_image_4 = models.ImageField("3. Gallery - Image", null=True, blank=True, help_text="Please upload images 600x400. Max 300px")
    gallery_image_alt_text_4 = models.CharField("3. Gallery - Image Description", max_length=254, null=True, blank=True, help_text="'Alt' text required for image. Backend. Not seen on website")
    gallery_title_4 = models.CharField("3. Gallery - Title", max_length=254, null=True, blank=True)
    gallery_description_4 = models.CharField("3. Gallery - Description", max_length=254, null=True, blank=True)
    gallery_image_5 = models.ImageField("3. Gallery - Image", null=True, blank=True, help_text="Please upload images 600x400. Max 300px")
    gallery_image_alt_text_5 = models.CharField("3. Gallery - Image Description", max_length=254, null=True, blank=True, help_text="'Alt' text required for image. Backend. Not seen on website")
    gallery_title_5 = models.CharField("3. Gallery - Title", max_length=254, null=True, blank=True)
    gallery_description_5 = models.CharField("3. Gallery - Description", max_length=254, null=True, blank=True)
    gallery_image_6 = models.ImageField("3. Gallery - Image", null=True, blank=True, help_text="Please upload images 600x400. Max 300px")
    gallery_image_alt_text_6 = models.CharField("3. Gallery - Image Description", max_length=254, null=True, blank=True, help_text="'Alt' text required for image. Backend. Not seen on website")
    gallery_title_6 = models.CharField("3. Gallery - Title", max_length=254, null=True, blank=True)
    gallery_description_6 = models.CharField("3. Gallery - Description", max_length=254, null=True, blank=True)
