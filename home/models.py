...
class HomeAbout(models.Model):
    ...
    about_sub_title_3 = models.CharField("3. Title", max_length=254, null=True, blank=True)
    about_paragraph_3 = models.TextField("3. About - Paragraph ", max_length=1000, null=True, blank=True)
